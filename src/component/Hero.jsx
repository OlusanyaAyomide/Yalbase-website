    ...
    <div className='h-[70px] w-[70px]  mr-[15%] md:mr-[20%] ml-auto mb-4'>
      <Balls/>
        ...
        <div className='w-full relative'>
            <h1 className='text-center text-3xl mb-8 md:mb-2 sm:text-4xl md:text-5xl lg:text-6xl font-extrabold lg:mx-8'>Turn Your best customers into <span className='whitespace-nowrap text-[#A75FD2]'>Loyal fans</span></h1>
